...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap rounded-2xl text-sm font-medium transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-brand disabled:pointer-events-none disabled:opacity-50 transform hover:scale-105 active:scale-95",
  {
    variants: {
      variant: {
        ...
        outline: "border-2 border-white/30 bg-white/10 backdrop-blur-sm text-slate-700 shadow-glass hover:bg-white/20 hover:text-slate-800 hover:border-white/40",
        ...
        ghost: "text-slate-600 hover:bg-white/20 hover:text-slate-800 backdrop-blur-sm",
